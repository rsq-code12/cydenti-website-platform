  ...
  return (
    <section className="relative w-full overflow-visible bg-white pt-24 pb-12 lg:pt-32 lg:pb-12">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div 
          className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-blue-100/50 blur-3xl animate-pulse opacity-30" 
        />
        <div 
          className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-teal-100/50 blur-3xl animate-pulse delay-1000 opacity-30" 
        />

        ...
        <div className="relative rounded-[40px] border border-slate-200 bg-white overflow-hidden p-8 lg:p-12 w-full">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-0">
            ...
            <div className="flex flex-col justify-center gap-10 h-64 w-full lg:w-1/4 relative z-10">
               ...
               <div className="bg-white p-4 rounded-xl border border-slate-200 flex items-center gap-3 relative group">
            ...
            <div className="flex flex-col justify-center h-64 w-full lg:w-1/4 relative z-10">
               ...
               <div className="space-y-4">
                  <div className="bg-slate-900 p-4 rounded-xl border border-slate-800 flex items-center gap-3 relative group">
